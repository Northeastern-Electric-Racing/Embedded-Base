...
namespace Antmicro.Renode.Peripherals.Sensors
{
    ...
    {
        public LSM6DSO_IMU_NER(IMachine machine) : base(machine)
        {
            Interrupt1 = new GPIO();
        ...
        protected void TryIncrementAddress()
        {
        ...
        protected readonly LSM6DSO_FIFO commonFifo;
        ...
        protected class LSM6DSO_FIFO
        {
            public LSM6DSO_FIFO(IMachine machine, LSM6DSO_IMU_NER owner, string name, uint capacity)
            {
                Capacity = capacity;
            ...
            private readonly LSM6DSO_IMU_NER owner;
        }

        protected class LSM6DSO_Vector3DSample
        {
