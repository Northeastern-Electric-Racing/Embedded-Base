...
{
    public class STM32_CRC_NER : IBytePeripheral, IWordPeripheral, IDoubleWordPeripheral, IKnownSize
    {
        public STM32_CRC_NER(STM32Series series, bool configurablePoly = false)
        {
            STM32Config conf;
