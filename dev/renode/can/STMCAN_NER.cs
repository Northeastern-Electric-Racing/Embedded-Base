...
{
    public class STMCAN_NER : IDoubleWordPeripheral, ICAN, INumberedGPIOOutput
    {
        public STMCAN_NER(STMCAN_NER master = null)
        {
            // Register master CAN
            this.master = master;
        ...
        {
            this.Log(LogLevel.Debug, "TRANSMITTING MESSAGE: {0}", msg.CAN_RIR);
        ...
        public class CANMessage
        {
            ...
            public CANMessage(CANMessageFrame message)
            {
                ...
                RTR = (uint)(message.RemoteFrame ? 1 : 0);
        ...
        private readonly STMCAN_NER master;
