...
#define osKernelInitialize_Expect() TEST_FAIL_MESSAGE("osKernelInitialize requires _ExpectAndReturn");
...
#define osKernelRunning_Expect() TEST_FAIL_MESSAGE("osKernelRunning requires _ExpectAndReturn");
...
#define osKernelSysTick_Expect() TEST_FAIL_MESSAGE("osKernelSysTick requires _ExpectAndReturn");
...
#define osThreadCreate_Expect(thread_def, argument) TEST_FAIL_MESSAGE("osThreadCreate requires _ExpectAndReturn");
...
#define osThreadSetPriority_Expect(thread_id, priority) TEST_FAIL_MESSAGE("osThreadSetPriority requires _ExpectAndReturn");
...
#define osThreadGetPriority_Expect(thread_id) TEST_FAIL_MESSAGE("osThreadGetPriority requires _ExpectAndReturn");
...
#define osThreadYield_Expect() TEST_FAIL_MESSAGE("osThreadYield requires _ExpectAndReturn");
...
#define osThreadTerminate_Expect(thread_id) TEST_FAIL_MESSAGE("osThreadTerminate requires _ExpectAndReturn");
...
#define osSignalSet_Expect(thread_id, signals) TEST_FAIL_MESSAGE("osSignalSet requires _ExpectAndReturn");
...
#define osSignalClear_Expect(thread_id, signals) TEST_FAIL_MESSAGE("osSignalClear requires _ExpectAndReturn");
...
#define osSignalWait_Expect(signals, millisec) TEST_FAIL_MESSAGE("osSignalWait requires _ExpectAndReturn");
...
void osSignalWait_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, int32_t signals, uint32_t millisec, os_InRegs osEvent cmock_to_return);
#define osDelay_Expect(millisec) TEST_FAIL_MESSAGE("osDelay requires _ExpectAndReturn");
...
#define osWait_Expect(millisec) TEST_FAIL_MESSAGE("osWait requires _ExpectAndReturn");
#define osWait_ExpectAndReturn(millisec, cmock_retval) osWait_CMockExpectAndReturn(__LINE__, millisec, cmock_retval)
void osWait_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, uint32_t millisec, os_InRegs osEvent cmock_to_return);
#define osTimerCreate_Expect(timer_def, type, argument) TEST_FAIL_MESSAGE("osTimerCreate requires _ExpectAndReturn");
...
#define osTimerStart_Expect(timer_id, millisec) TEST_FAIL_MESSAGE("osTimerStart requires _ExpectAndReturn");
...
#define osTimerDelete_Expect(timer_id) TEST_FAIL_MESSAGE("osTimerDelete requires _ExpectAndReturn");
...
#define osMutexCreate_Expect(mutex_def) TEST_FAIL_MESSAGE("osMutexCreate requires _ExpectAndReturn");
...
#define osMutexWait_Expect(mutex_id, millisec) TEST_FAIL_MESSAGE("osMutexWait requires _ExpectAndReturn");
...
#define osMutexDelete_Expect(mutex_id) TEST_FAIL_MESSAGE("osMutexDelete requires _ExpectAndReturn");
...
#define osSemaphoreCreate_Expect(semaphore_def, count) TEST_FAIL_MESSAGE("osSemaphoreCreate requires _ExpectAndReturn");
...
#define osSemaphoreWait_Expect(semaphore_id, millisec) TEST_FAIL_MESSAGE("osSemaphoreWait requires _ExpectAndReturn");
...
#define osSemaphoreRelease_Expect(semaphore_id) TEST_FAIL_MESSAGE("osSemaphoreRelease requires _ExpectAndReturn");
...
#define osSemaphoreDelete_Expect(semaphore_id) TEST_FAIL_MESSAGE("osSemaphoreDelete requires _ExpectAndReturn");
...
#define osPoolCreate_Expect(pool_def) TEST_FAIL_MESSAGE("osPoolCreate requires _ExpectAndReturn");
...
#define osPoolAlloc_Expect(pool_id) TEST_FAIL_MESSAGE("osPoolAlloc requires _ExpectAndReturn");
...
#define osPoolCAlloc_Expect(pool_id) TEST_FAIL_MESSAGE("osPoolCAlloc requires _ExpectAndReturn");
...
#define osPoolFree_Expect(pool_id, block) TEST_FAIL_MESSAGE("osPoolFree requires _ExpectAndReturn");
...
#define osMessageCreate_Expect(queue_def, thread_id) TEST_FAIL_MESSAGE("osMessageCreate requires _ExpectAndReturn");
...
#define osMessagePut_Expect(queue_id, info, millisec) TEST_FAIL_MESSAGE("osMessagePut requires _ExpectAndReturn");
...
#define osMessageGet_Expect(queue_id, millisec) TEST_FAIL_MESSAGE("osMessageGet requires _ExpectAndReturn");
...
void osMessageGet_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, osMessageQId queue_id, uint32_t millisec, os_InRegs osEvent cmock_to_return);
#define osMailCreate_Expect(queue_def, thread_id) TEST_FAIL_MESSAGE("osMailCreate requires _ExpectAndReturn");
...
#define osMailAlloc_Expect(queue_id, millisec) TEST_FAIL_MESSAGE("osMailAlloc requires _ExpectAndReturn");
...
#define osMailCAlloc_Expect(queue_id, millisec) TEST_FAIL_MESSAGE("osMailCAlloc requires _ExpectAndReturn");
...
#define osMailPut_Expect(queue_id, mail) TEST_FAIL_MESSAGE("osMailPut requires _ExpectAndReturn");
...
void osMailPut_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, osMailQId queue_id, const void* mail, osStatus cmock_to_return);
#define osMailGet_Expect(queue_id, millisec) TEST_FAIL_MESSAGE("osMailGet requires _ExpectAndReturn");
...
void osMailGet_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, osMailQId queue_id, uint32_t millisec, os_InRegs osEvent cmock_to_return);
#define osMailFree_Expect(queue_id, mail) TEST_FAIL_MESSAGE("osMailFree requires _ExpectAndReturn");
