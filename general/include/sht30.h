...
typedef int (*Write_ptr)(uint8_t addr, const uint8_t *data, size_t len, uint32_t timeout);
typedef int (*Read_Ptr)(uint8_t addr, uint8_t *data, size_t len, uint32_t timeout);
typedef int (*Mem_Read_Ptr)(uint8_t addr, uint16_t mem_addr, uint16_t mem_addr_size, uint8_t *data, size_t len, uint32_t timeout);
