...
typedef int32_t (*LSM6DSO_WriteReg_Func)(uint16_t, uint16_t, uint8_t *,
					 uint16_t);
typedef int32_t (*LSM6DSO_ReadReg_Func)(uint16_t, uint16_t, uint8_t *,
					uint16_t);
...
typedef struct {
	...
	int32_t (*GetCapabilities)(LSM6DSO_Object_t *,
				   LSM6DSO_Capabilities_t *);
} LSM6DSO_CommonDrv_t;
...
int32_t LSM6DSO_ACC_GetSensitivity(LSM6DSO_Object_t *pObj,
				   float_t *Sensitivity);
...
int32_t LSM6DSO_ACC_GetAxesRaw(LSM6DSO_Object_t *pObj,
...
int32_t LSM6DSO_ACC_Set_Tap_Threshold(LSM6DSO_Object_t *pObj,
				      uint8_t Threshold);
...
int32_t LSM6DSO_ACC_Set_6D_Orientation_Threshold(LSM6DSO_Object_t *pObj,
						 uint8_t Threshold);
int32_t LSM6DSO_ACC_Get_6D_Orientation_XL(LSM6DSO_Object_t *pObj,
					  uint8_t *XLow);
int32_t LSM6DSO_ACC_Get_6D_Orientation_XH(LSM6DSO_Object_t *pObj,
					  uint8_t *XHigh);
int32_t LSM6DSO_ACC_Get_6D_Orientation_YL(LSM6DSO_Object_t *pObj,
					  uint8_t *YLow);
int32_t LSM6DSO_ACC_Get_6D_Orientation_YH(LSM6DSO_Object_t *pObj,
					  uint8_t *YHigh);
int32_t LSM6DSO_ACC_Get_6D_Orientation_ZL(LSM6DSO_Object_t *pObj,
					  uint8_t *ZLow);
...
int32_t LSM6DSO_FIFO_Get_Overrun_Status(LSM6DSO_Object_t *pObj,
					uint8_t *Status);
...
int32_t LSM6DSO_ACC_Set_Sleep_Duration(LSM6DSO_Object_t *pObj,
				       uint8_t Duration);
