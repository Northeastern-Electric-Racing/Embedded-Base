...
int32_t lsm6dsv_read_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data,
			 uint16_t len);
int32_t lsm6dsv_write_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data,
			  uint16_t len);
...
typedef enum {
	...
	LSM6DSV_RESTORE_CTRL_REGS =
		0x4, /* Reset control registers to default values */
} lsm6dsv_reset_t;
...
int32_t lsm6dsv_dual_acceleration_raw_get(const stmdev_ctx_t *ctx,
					  int16_t *val);
...
int32_t lsm6dsv_fifo_xl_dual_fsm_batch_set(const stmdev_ctx_t *ctx,
					   uint8_t val);
...
int32_t
lsm6dsv_filt_ois_settling_mask_set(const stmdev_ctx_t *ctx,
...
int32_t lsm6dsv_filt_xl_fast_settling_get(const stmdev_ctx_t *ctx,
					  uint8_t *val);
...
int32_t lsm6dsv_mask_trigger_xl_settl_get(const stmdev_ctx_t *ctx,
					  uint8_t *val);
...
int32_t lsm6dsv_fsm_long_cnt_timeout_get(const stmdev_ctx_t *ctx,
					 uint16_t *val);

int32_t lsm6dsv_fsm_number_of_programs_set(const stmdev_ctx_t *ctx,
					   uint8_t val);
...
int32_t lsm6dsv_ois_interface_pull_up_get(const stmdev_ctx_t *ctx,
					  uint8_t *val);
