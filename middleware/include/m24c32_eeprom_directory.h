 ...
 * @return int Error code. -1 if id is not a valid partition ID, -2 if attempting to write
 ...
 */
int m24c32_directory_read(const struct eeprom_directory *directory,
			  m24c32_t *eeprom, char *id, uint8_t data, size_t len,
			  size_t offset);